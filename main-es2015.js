...
const routes = [
    ...
    { path: 'user/:id', component: _user_details_user_details_component__WEBPACK_IMPORTED_MODULE_3__["UserDetailsComponent"] },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postDataCaptureService", function() { return postDataCaptureService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let postDataCaptureService = class postDataCaptureService {
    constructor(http) {
        this.http = http;
    }
    getAlluser() {
    ...
    getUserOnSelect(id) {
        let url = 'https://jsonplaceholder.typicode.com/posts?id=' + id;
        return this.http.get(url);
    }
};
postDataCaptureService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
postDataCaptureService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _post_dataCapture_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../post-dataCapture.service */ "./src/app/post-dataCapture.service.ts");
...
let UserComponent = class UserComponent {
    constructor(userService) {
        ...
        const combination = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])([one, two]);
    ...
    filteredEmployee(searchString) {
        return this.userList.filter(user => user.name.toLowerCase().indexOf(searchString.toLowerCase()) !== -1);
    }
    ngOnInit() {
    }
    ngOnDestroy() {
...
module.exports = __webpack_require__(/*! /home/niraj/Angular/DecisionPointUi/src/main.ts */"./src/main.ts");
